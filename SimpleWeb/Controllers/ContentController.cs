...
namespace SimpleWeb.Controllers
{
    ...
    public class ContentController : Controller
    {
        ...
        public async Task<IActionResult> Get(string id)
        {
            ...
            if (resContent.Data.ContentDataOneofCase == ON.Fragments.Content.ContentPublicData.ContentDataOneofOneofCase.Video)
                return View("ViewVideo", vm);
            if (resContent.Data.ContentDataOneofCase == ON.Fragments.Content.ContentPublicData.ContentDataOneofOneofCase.Written)
